...
module.exports = function (app, database) {
   ...
   **/
    app.get('/chart/learner-dashboard-user4', function (req, res) { // === url
        Promise.props({
            // get the videos from database
            videos: LogExt2.find().distinct('video_file').execAsync(),
        }).then(function (results) {
            res.render('chartLearnerDashboardUser4', {  // === view-filename
                menu: menu,
     ...
     */
    // Aufruf aus Cache?!?!
           app.get('/data/learner-dashboard-user4/timespent-video/video/:video', function (req, res) {
     ...
     *    PEAKS ******************
     */
    app.get('/data/learner-dashboard-user4/peaks/video/:video', function (req, res) {
